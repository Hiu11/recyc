...
public class ContactViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
  ...
  public ContactViewHolder(View itemView, ContactListAdapter adapter) {
    ...
    wordItemView = itemView.findViewById(R.id.textViewName);
    phoneItemView = itemView.findViewById(R.id.textViewPhone);
    imageViewItem = itemView.findViewById(R.id.imageView);
    buttonItem = itemView.findViewById(R.id.button);
    this.mAdapter = adapter;

    itemView.setOnClickListener(this);

    // Đặt biểu tượng điện thoại và thêm sự kiện nhấn vào biểu tượng để gọi điện
    imageViewItem.setImageResource(R.drawable.ic_phone); // Đảm bảo bạn có `ic_phone` trong tài nguyên drawable
